...
const fadeDisplay = () => {
	const cc = document.getElementById("currentForecast"); // cc=currentconditions
...
const setBGImage = (weatherClass) => {
	document.documentElement.classList.add(weatherClass); // selects the classlist of the html/root element
